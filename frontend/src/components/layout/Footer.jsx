        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {[
                { icon: '📍', text: isAr ? 'دبي، الإمارات العربية المتحدة' : 'Dubai, UAE' },
                { icon: '📞', text: '+971 4 000 0000' },
                { icon: '✉️', text: 'hello@luxeessence.com' },
              ].map((item, i) => (
                <p key={i} style={{ color: 'var(--color-gray)', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
